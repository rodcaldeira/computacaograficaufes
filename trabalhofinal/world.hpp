...
private:
  ...
  void DesenhaIsland(GLfloat x, GLfloat y, GLfloat pos_z, GLfloat radius, GLfloat tower_radius, GLfloat height, GLfloat R, GLfloat G, GLfloat B);//, GLfloat theta2, GLfloat theta3);
  void DesenhaCylinder(GLfloat x, GLfloat y, GLfloat z, GLfloat rad, GLfloat h, GLfloat R, GLfloat G, GLfloat B);
  void DesenhaSphere(GLfloat x, GLfloat y, GLfloat z, GLfloat tower_radius, GLfloat R, GLfloat G, GLfloat B);
public:
  Island(GLint ident, GLfloat colors[3], GLfloat x = 0.0, GLfloat y = 0.0, GLfloat z = 0.0, GLfloat rad = 1.0, GLfloat t_perc = 0.0, GLfloat h = 1.0) {
    id = ident;
    pos_x = x;
    pos_y = y;
    pos_z = z;
  ...
  void Desenha() {
    DesenhaIsland(pos_x, pos_y, pos_z, radius, tower_perc, height, rgb[0], rgb[1], rgb[2]);
  }
